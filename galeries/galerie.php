...
<body>
	<div class="container">
		...
		<div class='col-sm-12 col-xs-12 row'>
			...
			<div class="themes">
				<button onclick="location.href='ajout.php?update=1&galerie=<?php echo $galerie->nom?>'">Modifier</button>
				<button onclick="supprimer('<?php echo $galerie->nom?>');">Supprimer</button>
			</div>
			<div class='space'></div>
			<div class='galerie'>
