...
<title>GALERIE-AJOUTER UNE IMAGE</title>
    ...
    <div class="container">
		...
		print("<button onclick=\"filtrer(-1)\">Tous les th̬mes</button>");
	    ?>
    	...
    	<div class='galeries'>
    		...
    		<div class="media <?php print($galerie->theme);?>">
			  <a class="media-left pull-left" href="galerie.php?galerie=<?php print($galerie->nom);?>">
			    <img height=100 width=100 src="<?php print($galerie->getIcone());?>" alt="<?php print($galerie->titre);?>">
			  </a>
			  <div class="media-body">
			    <h4 class="media-heading">
			    	<a href="galerie.php?galerie=<?php print($galerie->nom);?>">
